...
const politicasPrivacidade = () => {
    ...
    return (
        ...
        <Head>
            <title>Políticas de Privacidade - Dinâmico Tech</title>
            <meta
...
<p>A sua privacidade é importante para nós. É política do site Dinâmico Tech respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://dinamico-tech.vercel.app/" target="_blank" rel="noopener">Dinâmico Tech</a>, e outros sites que possuímos e operamos.</p>
...
<p>Fica, desde já, o titular de dados ciente que o conteúdo desta Política de Privacidade pode ser alterado a critério do site Dinâmico Tech, independente de aviso ou notificação.  Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site. </p>

<p>O site Dinâmico Tech não se responsabiliza caso você venha utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.</p>
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o site Dinâmico Tech oferece e com caráter enunciativo, mas não limitativo:</p>
...
<li>D) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do site Dinâmico Tech, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados;</li>
...
<p>O titular de dados pessoais possui o direito de solicitar do site Dinâmico Tech, através do canal específico de tratamento, a qualquer momento, mediante requisição formal, informações referentes aos seus dados.</p>
...
<p>O site Dinâmico Tech empregará esforços para resguardar as informações e dados coletados do usuário pelo site. Todavia, considerando que não há meio de transmissão e retenção de dados eletrônicos plenamente eficaz e seguro, o site Dinâmico Tech não pode assegurar que terceiros não autorizados não logrem êxito no acesso indevido, eximindo-se de qualquer responsabilidade por danos e prejuízos decorrentes da conduta de terceiros, ataques externos ao site como: vírus, invasão ao banco de dados, vícios ou defeitos técnicos, assim como operacionais resultante da utilização do site e em razão de falhas de conexão.</p>
